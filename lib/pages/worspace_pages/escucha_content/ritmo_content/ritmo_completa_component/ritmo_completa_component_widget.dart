...
import 'ritmo_completa_component_model.dart';
export 'ritmo_completa_component_model.dart';

/// example
///
class RitmoCompletaComponentWidget extends StatefulWidget {
  const RitmoCompletaComponentWidget({super.key});

  @override
  State<RitmoCompletaComponentWidget> createState() =>
      _RitmoCompletaComponentWidgetState();
}

class _RitmoCompletaComponentWidgetState
    extends State<RitmoCompletaComponentWidget> with TickerProviderStateMixin {
  late RitmoCompletaComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RitmoCompletaComponentModel());
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [Color(0xB7245796), Color(0xF7245F96)],
                  stops: [0.0, 1.0],
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Vamos a respirar con todo el cuerpo.',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .titleLarge
                                    .override(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Primero abdomen, luego pecho, después clavículas.',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Deja que el aire baje suavemente.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
