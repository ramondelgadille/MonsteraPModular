...
import 'ritmo_clavicular_component_model.dart';
export 'ritmo_clavicular_component_model.dart';

/// example
///
class RitmoClavicularComponentWidget extends StatefulWidget {
  const RitmoClavicularComponentWidget({super.key});

  @override
  State<RitmoClavicularComponentWidget> createState() =>
      _RitmoClavicularComponentWidgetState();
}

class _RitmoClavicularComponentWidgetState
    extends State<RitmoClavicularComponentWidget>
    with TickerProviderStateMixin {
  late RitmoClavicularComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RitmoClavicularComponentModel());
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [Color(0xB7249690), Color(0xCB249692)],
                  stops: [0.0, 1.0],
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Vamos a usar la parte alta del pecho.',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .titleLarge
                                    .override(
                              ...
                              Text(
                                'Una respiración ligera y sutil.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Siente cómo suben tus clavículas.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Deja que todo baje con suavidad.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Tu aire se eleva y cae sin esfuerzo.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
