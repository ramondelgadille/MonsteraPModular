...
import 'ritmo_toracica_component_model.dart';
export 'ritmo_toracica_component_model.dart';

/// example
///
class RitmoToracicaComponentWidget extends StatefulWidget {
  const RitmoToracicaComponentWidget({super.key});

  @override
  State<RitmoToracicaComponentWidget> createState() =>
      _RitmoToracicaComponentWidgetState();
}

class _RitmoToracicaComponentWidgetState
    extends State<RitmoToracicaComponentWidget> with TickerProviderStateMixin {
  late RitmoToracicaComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RitmoToracicaComponentModel());
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [Color(0xB7622496), Color(0xF76A2496)],
                  stops: [0.0, 1.0],
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Expandiendo espacio desde el corazón.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Siente cómo se abren tus costillas.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Tu pecho está expandido, abierto.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'El movimiento vuelve hacia el centro.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.nunito(
