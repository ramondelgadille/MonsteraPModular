                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ToggleIcon(
                                onPressed: () async {
                                  safeSetState(() =>
                                      _model.showPanel = !_model.showPanel);
                                },
                                value: _model.showPanel,
                                onIcon: FaIcon(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 4.0, 0.0, 0.0),
                            child:
                                StreamBuilder<List<SubcollectionTasksRecord>>(
                              stream: querySubcollectionTasksRecord(
                                parent: FFAppState().user,
                                queryBuilder: (subcollectionTasksRecord) =>
                                    subcollectionTasksRecord
                                        .where(
                                          'estado',
                                          isEqualTo: 1,
                                        )
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<SubcollectionTasksRecord>
                                    listViewSubcollectionTasksRecordList =
                                    snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewSubcollectionTasksRecord =
                                        listViewSubcollectionTasksRecordList[
                                            listViewIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                            ...
                                            children: [
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    4.0),
                                                        child: Text(
                                                          listViewSubcollectionTasksRecord
                                                              .categoria,
                                              ...
                                              Padding(
                                                ...
                                                child: FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    await listViewSubcollectionTasksRecord
                                                        .reference
                                                        .update(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 0.0),
                                  child: Text(
                                    'Pasos pequeños, para lograr cambios.',
                                    style: FlutterFlowTheme.of(context)
                                        .labelSmall
                                        .override(
                                          font: GoogleFonts.nunito(
