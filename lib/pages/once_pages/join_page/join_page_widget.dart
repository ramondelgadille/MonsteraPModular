import '/components/begin_component/begin_component_widget.dart';
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 12.0,
                                                                0.0, 24.0),
                                                    child: Text(
                                                      '¡Hola de nuevo! Completa con tu información, aqui abajo.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 12.0,
                                                                0.0, 24.0),
                                                    child: Text(
                                                      'Empecemos a crear tu espacio seguro, llena los datos siguientes.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
              ...
              wrapWithModel(
                model: _model.beginComponentModel,
                updateCallback: () => safeSetState(() {}),
                child: BeginComponentWidget(),
              ),
            ],
          ),
        ),
