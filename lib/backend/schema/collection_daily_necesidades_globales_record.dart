...
/// Registro global diario de necesidades.
class CollectionDailyNecesidadesGlobalesRecord extends FirestoreRecord {
  CollectionDailyNecesidadesGlobalesRecord._(
  ...
  static CollectionReference get collection => FirebaseFirestore.instance
      .collection('collection_daily_necesidades_globales');

  static Stream<CollectionDailyNecesidadesGlobalesRecord> getDocument(
          DocumentReference ref) =>
      ref
          .snapshots()
          .map((s) => CollectionDailyNecesidadesGlobalesRecord.fromSnapshot(s));

  static Future<CollectionDailyNecesidadesGlobalesRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then(
          (s) => CollectionDailyNecesidadesGlobalesRecord.fromSnapshot(s));

  static CollectionDailyNecesidadesGlobalesRecord fromSnapshot(
  ...
  static CollectionDailyNecesidadesGlobalesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      CollectionDailyNecesidadesGlobalesRecord._(
  ...
  @override
  String toString() =>
      'CollectionDailyNecesidadesGlobalesRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is CollectionDailyNecesidadesGlobalesRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createCollectionDailyNecesidadesGlobalesRecordData({
  DateTime? fecha,
  bool? comer,
  bool? social,
  bool? respirar,
...
class CollectionDailyNecesidadesGlobalesRecordDocumentEquality
    implements Equality<CollectionDailyNecesidadesGlobalesRecord> {
  const CollectionDailyNecesidadesGlobalesRecordDocumentEquality();

  @override
  bool equals(CollectionDailyNecesidadesGlobalesRecord? e1,
      CollectionDailyNecesidadesGlobalesRecord? e2) {
  ...
  @override
  int hash(CollectionDailyNecesidadesGlobalesRecord? e) =>
  ...
  @override
  bool isValidKey(Object? o) => o is CollectionDailyNecesidadesGlobalesRecord;
}
